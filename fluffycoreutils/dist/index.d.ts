...
export { awk, basename, cat, chmod, clear, cp, curl, cut, date, diff, dirname, echo, env, expand, exportCmd, find, grep, head, hostname, less, ln, ls, mkdir, mv, printf, pwd, readlink, realpath, rm, sed, seq, sleep, sort, tail, tar, tee, test, time, touch, tr, unexpand, uniq, uname, wc, which, whoami, xargs, yes, falseCmd as false, trueCmd as true, };
