...
export { basename, cat, chmod, clear, cp, cut, date, diff, dirname, echo, env, find, grep, head, hostname, ln, ls, mkdir, mv, printf, pwd, readlink, rm, sed, sort, tail, tee, test, touch, tr, uniq, uname, wc, whoami, xargs, falseCmd as false, trueCmd as true, };
