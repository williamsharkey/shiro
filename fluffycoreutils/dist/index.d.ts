...
export { awk, base64, basename, cat, chmod, clear, comm, cp, curl, cut, date, diff, dirname, echo, env, expand, expr, exportCmd, file, find, fmt, fold, grep, head, hexdump, hostname, id, join, less, ln, ls, make, md5sum, mkdir, mv, nl, od, paste, patch, printenv, printf, pwd, readlink, realpath, rm, sed, seq, sha256sum, sleep, sort, stat, strings, tail, tar, tee, test, time, timeout, touch, tr, type, unexpand, uniq, uname, wc, which, whoami, xargs, yes, falseCmd as false, trueCmd as true, };
