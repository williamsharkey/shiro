...
export { awk, basename, cat, chmod, clear, comm, cp, curl, cut, date, diff, dirname, echo, env, expand, expr, exportCmd, file, find, fmt, fold, grep, head, hostname, id, join, less, ln, ls, mkdir, mv, nl, paste, printenv, printf, pwd, readlink, realpath, rm, sed, seq, sleep, sort, stat, tail, tar, tee, test, time, timeout, touch, tr, type, unexpand, uniq, uname, wc, which, whoami, xargs, yes, falseCmd as false, trueCmd as true, };
