...
export {
  awk, base64, basename, cat, chmod, clear, comm, cp, curl, cut, date, diff, dirname,
  echo, env, expand, expr, exportCmd, file, find, fmt, fold, grep, head, hexdump, hostname, id, join, less, ln, ls,
  ...
  tail, tar, tee, test, time, timeout, touch, tr, type, unexpand, uniq, uname, wc, which, whoami, xargs, yes,
  falseCmd as false,
  trueCmd as true,
};
...
export const allCommands: Record<string, FluffyCommand> = {
  awk, base64, basename, cat, chmod, clear, comm, cp, curl, cut, date, diff, dirname,
  echo, env, expand, expr, export: exportCmd, false: falseCmd, file, find, fmt, fold, grep, head, hexdump, hostname, id, join, less, ln,
  ...
  tail, tar, tee, test, time, timeout, touch, tr, true: trueCmd, type, unexpand, uniq, uname, wc, which, whoami, xargs, yes,
};
